...
<body>
    ...
    <div class="container">
        <h1>Mon Compte</h1>
        <div id="account-info">
            <!-- Informations du compte affichées ici -->
        </div>
        <div id="order-history">
            <!-- Historique des commandes affiché ici -->
        </div>
        <div id="favorite-products">
            <!-- Produits favoris affichés ici -->
        </div>
        <div id="saved-customizations">
            <!-- Personnalisations sauvegardées affichées ici -->
        </div>
        <button id="edit-account-btn">Modifier mes informations</button>
        <div id="edit-account-form">
            <!-- Formulaire de modification des informations affiché ici -->
        </div>
    </div>
